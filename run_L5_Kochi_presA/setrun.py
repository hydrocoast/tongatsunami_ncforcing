...
topoflist = {
             ...
             "Kochi"          :"zone04_depth_0090-03_lonlat.asc",
...
#------------------------------
    ...
    ## Level 4
    regions.append([1, 4, 4.0*3600.0, clawdata.tfinal, 132.0, 138.0, 27.0, 34.0])
    ## Level 5
    ...
    topo_file = topotools.Topography(os.path.join(topodir, topoflist['Kochi']), topo_type=3)
    regions.append([1, 5, 4.0*3600.0, clawdata.tfinal, topo_file.x[0], topo_file.x[-1], topo_file.y[0], topo_file.y[-1]])
...
#-------------------
    ...
    topo_data.topofiles.append( [3, os.path.join(topodir, topoflist['Kochi'])] )
