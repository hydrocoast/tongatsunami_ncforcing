...
#------------------------------
    ...
    clawdata.lower[0] = 130.0    # west longitude
    ...
    regions.append([1, 3, 4.0*3600.0, clawdata.tfinal, 130.0, 150.0, 10.0, 35.0])
    ## Level 4
    regions.append([1, 4, 4.0*3600.0, clawdata.tfinal, 132.0, 139.0, 29.0, 34.5])
    ## Level 5
