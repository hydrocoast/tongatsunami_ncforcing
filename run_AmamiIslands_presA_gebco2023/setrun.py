...
# topolist
topoflist = {
             "GEBCO2023"      :"gebco2023_w105_e210_s-60_n60.nc",
             "Amami"          :"zone01_depth_0090-03_lonlat.asc",
             "AmamiKikai"     :"zone01_depth_0090_blend34.asc",
             "AmamiIslands"   :"zone01_depth_0090_blend1234.asc",
...
#------------------------------
    ...
    ## Level 4
    regions.append([1, 4, 4.5*3600.0, clawdata.tfinal, 126.0, 136.0, 20.0, 29.0])
    ## Level 5
    topo_file = topotools.Topography(os.path.join(topodir, topoflist['AmamiIslands']), topo_type=3)
...
#-------------------
    ...
    # smaller domains
    topo_data.topofiles.append( [4, os.path.join(topodir, topoflist['GEBCO2023'])] )
    #topo_data.topofiles.append( [3, os.path.join(topodir, topoflist['Amami'])] )
    topo_data.topofiles.append( [3, os.path.join(topodir, topoflist['AmamiIslands'])] )
