...
#------------------------------
    ...
    #regions.append([1, 4, 4.5*3600.0, clawdata.tfinal, 120.0, 135.0, 20.0, 33.0])
    regions.append([1, 4, 4.5*3600.0, clawdata.tfinal, 120.0, 131.0, 26.0, 33.0])
...
#-------------------
    ...
    refine_data.wave_tolerance = 0.04
