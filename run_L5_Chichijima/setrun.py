...
#------------------------------
    ...
    clawdata.lower[0] = 135.0    # west longitude
    ...
    regions.append([1, 3, 4.0*3600.0, clawdata.tfinal, 135.0, 155.0, 0.0, 35.0])
    ## Level 4
    regions.append([1, 4, 4.0*3600.0, clawdata.tfinal, 137.0, 150.0, 5.0, 30.0])
    ## Level 5
