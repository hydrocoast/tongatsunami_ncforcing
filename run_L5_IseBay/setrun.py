...
#------------------------------
    ...
    clawdata.lower[0] = 134.0   # west longitude
    clawdata.upper[0] = 200.0   # east longitude
    clawdata.lower[1] = -55.0   # south latitude
    clawdata.upper[1] =  36.0   # north latitude
    ...
    regions.append([1, 3, 4.0*3600.0, clawdata.tfinal, 134.0, 150.0, 10.0, 36.0])
    ## Level 4
    regions.append([1, 4, 4.0*3600.0, clawdata.tfinal, 134.0, 140.0, 29.0, 35.5])
    ## Level 5
