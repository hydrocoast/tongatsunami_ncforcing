...
#------------------------------
    ...
    regions.append([1, 3, 3.0*3600.0, clawdata.tfinal, 115.0, 150.0, 10.0, 35.0])
    regions.append([1, 4, 3.5*3600.0, clawdata.tfinal, 120.0, 140.0, 15.0, 33.0])
    ...
    fgout.tstart = 3600.0*3.5
    fgout.tend = 3600.0*11.5
